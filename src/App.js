    ...
    <div className="wrapper">
      ...
      <div className="content p-40">
        ...
        <div className="sneakers">
          <div className="card">
            <div className="mb-15">
              <img className="mb-15" src="/images/sneakers/sneakers1.jpg" />
              <div>
            ...
            <div className="card__info d-flex justify-between align-center">
              <div className="card__info-cost d-flex flex-column ">
                <span className="card__info-cost_text text-uppercase">
                  Цена:
                </span>
          ...
          <div className="card">
            <div className="mb-15">
              <img className="mb-15" src="/images/sneakers/sneakers2.jpg" />
              <div>
                <p>Мужские Кроссовки</p>
                <p> Nike Blazer Mid Suede</p>
              </div>
          ...
          <div className="card">
            <div className="mb-15">
              <img className="mb-15" src="/images/sneakers/sneakers3.jpg" />
              <div>
                <p>Мужские Кроссовки</p>
                <p> Nike Blazer Mid Suede</p>
              </div>
          ...
          <div className="card">
            <div className="mb-15">
              <img className="mb-15" src="/images/sneakers/sneakers4.jpg" />
              <div>
                <p>Мужские Кроссовки</p>
                <p> Nike Blazer Mid Suede</p>
              </div>
